...
7. **Interface web**: página simples com formulário de voto, integração com CAPTCHA e renderização da parcial.
...
- Criar `COMMENTS.md` logo no início e registrar cada decisão, teste executado, problemas encontrados e ideias futuras.
- Usar issues/tarefas para rastrear progresso das etapas do plano.
- Ajustar o plano conforme aprendizados aparecerem, sempre documentados no arquivo de histórico.
